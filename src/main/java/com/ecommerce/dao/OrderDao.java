...
//import com.oracle.wls.shaded.org.apache.xpath.operations;
...
public class OrderDao {
    ...
    public List<CartProduct> getSellerOrderDetail(int productId) throws IOException {
    ...
    public List<CartProduct> getOrderDetailHistory(int orderId) throws IOException {
        List<CartProduct> list = new ArrayList<>();
